...
import loyalty2 from './Artboard 24@300x.png'
import video from './Smagic_Web_ticket_1.gif'
const Loyalty = () => {
    return (
        <section className='loyalty'>
            <div className="loyalty container">
                ...
                <div className="loyalty__box">
                    ...
                    <div className="loyalty__info">
                        <h3>10е посещение бесплатно</h3>
<p>Данная карта дает право получать скидку 30% на посещение детских центров развлечений. Держателю данной карточки лояльности необходимо собрать 9 печатей, где 1 печать = 1 посещение. Затем держатель карточки, получает 10е посещение бесплатно»</p>                    </div>
                </div>
            </div>
