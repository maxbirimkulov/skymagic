...
import Card3dContent from "./Card3dContent/Card3dContent";
...
const Shadow = styled.div`
  ...
  box-shadow: rgba(0, 0, 0, 06) 0 50px 100px -30px;
`;
...
export function Card3d({ height = 400, width = 300 ,price,text,dataPark,img}) {
    const ref = useRef();
    ...
    return (
        <Container ref={ref} className="price__card" style={{ height: `${height}px`, width: `${width}px` }}>
            ...
            >
                ...
                <RelativeContainer>
                    <Image />
                     <Card3dContent price={price} text={text} dataPark={dataPark} img={img}/>
                </RelativeContainer>
                <Gradient
                    style={{
                        background: gradient
